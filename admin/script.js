...
function defaultStore() {
  ...
  return {
    ...
    settings: {
      ...
      reviewCards: {
        gis: { reviewUrl: "https://2gis.ru/", buttonUrl: "https://2gis.ru/", qrUrl: "https://2gis.ru/", qrImage: "../assets/qr-2gis.svg" },
        yandex: { reviewUrl: "https://yandex.ru/maps/", buttonUrl: "https://yandex.ru/maps/", qrUrl: "https://yandex.ru/maps/", qrImage: "../assets/qr-yandex.svg" },
      },
...
function fillSettings(settings) {
  ...
  if (reviewCardsForm) {
    ...
    reviewCardsForm.elements.gisReviewUrl.value = settings.reviewCards?.gis?.reviewUrl || "";
    ...
    reviewCardsForm.elements.yandexReviewUrl.value = settings.reviewCards?.yandex?.reviewUrl || "";
...
reviewCardsForm?.addEventListener("submit", async (event) => {
  ...
  nextSettings.reviewCards.gis.qrUrl = nextSettings.reviewCards.gis.reviewUrl || nextSettings.reviewCards.gis.buttonUrl;
  ...
  nextSettings.reviewCards.yandex.qrUrl = nextSettings.reviewCards.yandex.reviewUrl || nextSettings.reviewCards.yandex.buttonUrl;
